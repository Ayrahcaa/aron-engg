            ...
            <div className="nepal">
              ...
              <div className="nepal-services-list">
                <div className="list-card">
                  ...
                  <h4 className="heading4">Multi-purpose covered hall</h4>
                </div>
                <div className="list-card">
                  <img src={Stadium} alt="stadium" />

                  <h4 className="heading4">Stadium</h4>
                </div>
                <div className="list-card">
                  <img src={CommercialStructure} alt="commercial structure" />

                  <h4 className="heading4">Commercial Structures</h4>
                </div>
                <div className="list-card">
                  <img src={ResidentialSturcture} alt="residential structure" />

                  <h4 className="heading4">Residential Structures</h4>
                </div>
                <div className="list-card">
                  <img src={PublicBuilding} alt="public building" />

                  <h4 className="heading4">Public Buildings</h4>
                </div>
                <div className="list-card">
                  <img src={Landscaping} alt="landscaping" />

                  <h4 className="heading4">Landscaping</h4>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="services-content-third">
            ...
            <div className="other-services-list">
              <div className="list-card">
                ...
                <h1>02</h1>
                <h4 className="heading5">Geotechnical/ Geological Design</h4>
              </div>
              <div className="list-card">
                <img src={UrbanPlanning} alt="urban planning" />
                <h1>03</h1>
                <h4 className="heading5">Urban Planning </h4>
              </div>
              <div className="list-card">
                <img src={Transportation} alt="transportation" />
                <h1>04</h1>
                <h4 className="heading5">Transportation</h4>
              </div>

              <div className="list-card">
                <img src={WaterSupply} alt="watersupply" />
                <h1>05</h1>
                <h4 className="heading5">Water Supply & Sanitary Design</h4>
              </div>
              <div className="list-card">
                <img src={ElectricalWorks} alt="electrical works" />
                <h1>06</h1>
                <h4 className="heading5">Electrical Works </h4>
              </div>
              <div className="list-card">
                <img src={Sewage} alt="sewage" />
                <h1>07</h1>
                <h4 className="heading5">Sewerage & Land-fill Site Design</h4>
              </div>
              <div className="list-card">
                <img src={Irrigation} alt="irrigation" />
                <h1>08</h1>
                <h4 className="heading5">Irrigation</h4>
              </div>
              <div className="list-card">
                <img src={RemoteSensing} alt="remote sensing" />
                <h1>09</h1>
                <h4 className="heading5">
                  Remote Sensing based survey and mapping{" "}
                </h4>
              </div>
              <div className="list-card">
                <img src={Valuation} alt="valuation" />
                <h1>10</h1>
                <h4 className="heading5">Valuation </h4>
              </div>
              <div className="list-card">
                <img src={feasibility} alt="feasibility study" />
                <h1>11</h1>
                <h4 className="heading5">Feasibility Study </h4>
              </div>
              <div className="list-card">
                <img src={rivertraining} alt="river training works" />
                <h1>12</h1>
                <h4 className="heading5">River- training works </h4>
              </div>
              <div className="list-card">
                <img src={SoftwareTraining} alt="software training" />
                <h1>13</h1>
                <h4 className="heading5">Software trainings </h4>
              </div>
            </div>
          </div>
        </div>
